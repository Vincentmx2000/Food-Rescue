...
(function (TaskStatus) {
    ...
    TaskStatus["DISTRIBUTED"] = "DISTRIBUTED";
...
const volunteerTaskSchema = new mongoose_1.Schema({
    ...
    volunteerId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User' }, // Not required for OPEN
...
exports.default = mongoose_1.default.model('VolunteerTask', volunteerTaskSchema);
