...
const AdminDonations: React.FC = () => {
    ...
    const getStatusBadge = (status: string) => {
        ...
        return `px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border-2 ${styles[status as keyof typeof styles] || 'bg-slate-50 border-slate-100 text-slate-400'}`;
    };
